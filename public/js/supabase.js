      ...
      s = {
          ...
          async function R(e, t, s, r) {
            ...
            const a = Object.keys(o).length
              ...
              c = await (async function (e, t, s, r, i, n) {
                ...
                if (
                  (a.ok || (await A(a)), null == r ? void 0 : r.noResolveJson)
                )
                  return a;
                try {
                  return await a.json();
            ...
            async listUsers(e) {
              ...
              try {
                ...
                const l = await h.json(),
                  u =
                    null !== (n = h.headers.get("x-total-count")) &&
                    void 0 !== n
                      ? n
                      : 0,
                  d =
            ...
            async updateUserById(e, t) {
              try {
                return await R(
                  ...
                  "PUT",
                  `${this.url}/admin/users/${e}`,
                  { body: t, headers: this.headers, xform: L }
                );
              } catch (e) {
                if (v(e)) return { data: { user: null }, error: e };
                throw e;
          ...
          class X {
              ...
              if (
                ...
                this.persistSession
                  ? s.storage
                    ...
                    ? (this.storage = B)
                    : ((this.memoryStorage = {}),
                      (this.storage = J(this.memoryStorage)))
                  : ((this.memoryStorage = {}),
                    (this.storage = J(this.memoryStorage))),
                r() &&
            ...
            async _getSessionFromURL(e) {
              try {
                ...
                if ("pkce" == this.flowType && !e)
                  throw new O("Not a valid PKCE flow url.");
                ...
                if (!(n && c && a && l))
                  throw new j("No session defined in URL");
            ...
            _persistSession(e) {
              return (
                ...
                h(this.storage, this.storageKey, e)
              );
            }
        ...
        189: (e, t, s) => {
          ...
          class o extends n {
            ...
            order(
              e,
              { ascending: t = !0, nullsFirst: s, foreignTable: r } = {}
            ) {
        ...
        73: (e, t, s) => {
          ...
          class P {
                    ...
                    .receive("ok", ({ postgres_changes: t }) => {
                      ...
                      if (
                        ...
                        for (let s = 0; s < i; s++) {
                          ...
                          n.push(
                            Object.assign(Object.assign({}, i), { id: l.id })
                          );
                        }
                        return (
            ...
            _trigger(e, t, s) {
              ...
              if (s && [o, c, h, l].indexOf(n) >= 0 && s !== this._joinRef())
                return;
          ...
          class x {
            constructor(e, t) {
              ...
              const h =
                null === (o = null == t ? void 0 : t.params) || void 0 === o
                  ? void 0
                  : o.apikey;
              ...
              c(void 0, void 0, void 0, function* () {
                ...
                (l = function* () {
                  return "undefined" == typeof Response
                    ? (yield Promise.resolve().then(s.t.bind(s, 743, 23)))
                        .Response
                    : Response;
                }),
            ...
            constructor(e, t, s) {
              ...
              (this.storageKey =
                ...
                (this.rest = new n.PostgrestClient(`${v}/rest/v1`, {
                  headers: this.headers,
                  schema:
                    null === (y = w.db) || void 0 === y ? void 0 : y.schema,
                  fetch: this.fetch,
                })),
